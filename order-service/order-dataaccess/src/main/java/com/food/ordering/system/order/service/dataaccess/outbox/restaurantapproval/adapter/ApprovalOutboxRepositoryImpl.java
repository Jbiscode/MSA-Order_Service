...
public class ApprovalOutboxRepositoryImpl implements ApprovalOutboxRepository {
    ...
    @Override
    public Optional<OrderApprovalOutboxMessage> save(OrderApprovalOutboxMessage orderApprovalOutboxMessage) {
        return Optional.ofNullable(approvalOutboxDataAccessMapper
