...
public class PaymentOutboxRepositoryImpl implements PaymentOutboxRepository {
    ...
    @Override
    public Optional<OrderPaymentOutboxMessage> save(OrderPaymentOutboxMessage orderPaymentOutboxMessage) {
        return Optional.ofNullable(paymentOutboxDataAccessMapper
