...
ALTER TABLE restaurant.restaurant_products
    ADD CONSTRAINT "FK_RESTAURANT_PRODUCTS_ON_RESTAURANTS" FOREIGN KEY (restaurant_id)
...
ALTER TABLE restaurant.restaurant_products
    ADD CONSTRAINT "FK_RESTAURANT_PRODUCTS_ON_PRODUCTS" FOREIGN KEY (product_id)
